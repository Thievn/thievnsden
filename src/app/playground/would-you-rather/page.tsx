  ...
  return (
    <div className="relative min-h-[calc(100vh-8rem)] overflow-hidden">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        />
        <div
          className="wyr-pulse-a absolute top-[8%] left-[8%] h-56 w-56 rounded-full blur-3xl bg-red-700/25"
        />
        <div
          className="wyr-pulse-b absolute top-[18%] right-[6%] h-64 w-64 rounded-full blur-3xl bg-purple-700/22"
        />
      ...
      <div className="relative pt-8 sm:pt-12">
        <div className="max-w-3xl lg:max-w-4xl mx-auto px-4 sm:px-6 mb-3">
