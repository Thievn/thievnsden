...
export const HEAT_CHIPS: Chip[] = [
  ...
  },
  {
    id: "filthy",
    label: "Filthy",
    desc: "Borderline NSFW amateur shots.",
    emoji: "🔥",
...
export const CLOTHES_WOMAN: Record<CastHeat, Chip[]> = {
  ...
  filthy: [
    { id: "black lace lingerie set", label: "Lingerie" },
    { id: "panties only", label: "Panties" },
    { id: "bra and panties", label: "Bra + panties" },
    ...
    { id: "sheer cami that shows the body underneath", label: "Sheer" },
    { id: "bikini bottoms only", label: "Bottoms only" },
    { id: "panties and a loose open robe", label: "Robe" },
  ],
};
