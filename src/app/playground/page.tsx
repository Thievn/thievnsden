  ...
  return (
    <div className="relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="void-orb-c absolute bottom-[-10%] left-[30%] h-[320px] w-[320px] rounded-full bg-[radial-gradient(circle,_rgba(239,68,68,0.1)_0%,_transparent_70%)] blur-3xl" />
      ...
      <div className="relative max-w-2xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
          ...
          <div className="relative rounded-2xl bg-[#111] overflow-hidden border border-neutral-800/60">
              ...
              <div className="p-6 sm:p-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <button
                    ...
                    className="invite-pulse group flex flex-col items-center justify-center gap-2 p-8 rounded-xl border border-dashed border-neutral-700 hover:border-red-900/50 hover:bg-red-950/10 transition-all duration-300 active:scale-[0.98]"
                  >
                  ...
                  <button
                    onClick={startCamera}
                    className="invite-pulse group flex flex-col items-center justify-center gap-2 p-8 rounded-xl border border-dashed border-neutral-700 hover:border-purple-900/50 hover:bg-purple-950/10 transition-all duration-300 active:scale-[0.98]"
            ...
            {stage === "setup" && image && (
              <div className="p-5 sm:p-7 space-y-6">
                <div className="relative aspect-square max-w-[200px] mx-auto rounded-xl overflow-hidden border border-neutral-800 shadow-[0_0_24px_-8px_rgba(185,28,92,0.35)]">
                ...
                <div>
                  <p className="text-xs text-neutral-500 mb-2.5 text-center uppercase tracking-wide">
                    Judgment style
                  </p>
                ...
                <button
                  onClick={() => judge(false)}
                  disabled={loading}
                  className="w-full py-3.5 rounded-xl bg-gradient-to-b from-red-700 via-red-800 to-purple-900 text-white font-medium text-sm transition-all active:scale-[0.98] disabled:opacity-60 shadow-lg shadow-red-950/40"
                >
                  Face The Den
                </button>
            ...
            {stage === "judging" && (
              <div className="p-12 sm:p-16 text-center">
                <div className="relative w-16 h-16 mx-auto mb-6">
                  ...
                  <div className="absolute inset-[-6px] rounded-full border border-red-900/30 animate-pulse" />
                  <div className="relative w-16 h-16 rounded-full border border-purple-900/50 flex items-center justify-center bg-[#0a0a0a]">
                    <div className="w-3.5 h-3.5 rounded-full bg-gradient-to-br from-red-500 to-purple-500 animate-pulse shadow-[0_0_20px_rgba(185,28,92,0.6)]" />
                  </div>
                </div>
        ...
        <p className="mt-8 text-center text-[11px] text-neutral-600">
          More playground experiments coming later.
        </p>
      </div>
    </div>
  );
