            ...
            >
              ...
              <div className="p-4 sm:p-5 flex flex-col flex-1">
                ...
                <div className="pt-3 border-t border-neutral-800/60">
                  <p className="text-xs text-neutral-500 mb-3 leading-relaxed line-clamp-3">
                    {item.review}
                  </p>
                  <a
                    href={item.link}
                    ...
                    className="inline-flex items-center gap-1.5 text-sm text-neutral-400 hover:text-red-300 transition-colors py-1"
                  >
                    Check it out
